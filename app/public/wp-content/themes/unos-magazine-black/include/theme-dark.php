...
add_action( 'wp_enqueue_scripts', 'unosmbl_enqueue_darkstyle', 22 ); // Load after @20 in parent which enqueues 'unos-child-hootkit'

function unosmbl_dynamic_css_dark_handle( $handle ) {
	return 'unosmbl-dark';
}
add_filter( 'hoot_style_builder_inline_style_handle', 'unosmbl_dynamic_css_dark_handle', 12 ); // Load after @10 in parent setting it to 'unos-child-hootkit'
...
add_action( 'hoot_dynamic_cssrules', 'unosmbl_dark_dynamic_cssrules', 3 );