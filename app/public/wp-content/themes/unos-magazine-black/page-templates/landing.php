...
add_filter( 'unos_layout', 'unosmbl_layout' );
function unosmbl_layout( $sidebar ){
	return apply_filters( 'unosmbl_layout', 'full-width', $sidebar );
}
...
<body <?php hoot_attr( 'body' ); ?>>
	...
	<a href="#main" class="screen-reader-text"><?php esc_html_e( 'Skip to content', 'unos-magazine-black' ); ?></a>
