...
add_action( 'after_setup_theme', 'unosmbl_enqueue_child_styles_backcompatibility', 3 );
function unosmbl_enqueue_child_styles_backcompatibility() {
	if ( !function_exists( 'hoot_enqueue_child_styles' ) )
		...
		add_filter( 'hoot_style_builder_inline_style_handle', 'unosmbl_dynamic_css_child_handle', 8 );
}
...
add_action( 'hoot_dynamic_cssrules', 'unosmbl_dynamic_cssrules', 3 );
...
function unosmbl_modify_customizer_options( $options ){
	...
	if ( isset( $options['settings']['widgetmargin'] ) )
		$options['settings']['widgetmargin']['input_attrs']['placeholder'] = esc_html__( 'default: 45', 'unos-magazine-black' );
 ...
 * @return void
 */
function unosmbl_customizer_enqueue_scripts() {
	if ( file_exists( hoot_data()->child_dir . 'admin/customize-controls.js' ) )
		wp_enqueue_script( 'unosmbl-customize-controls', hoot_data()->child_uri . 'admin/customize-controls.js', array( 'unos-customize-controls' ), hoot_data()->childtheme_version, true );
}
add_action( 'customize_controls_enqueue_scripts', 'unosmbl_customizer_enqueue_scripts', 15 );
...
function unosmbl_reset_customize_preview_setthemestyle(){
...
add_action( 'customize_controls_init', 'unosmbl_reset_customize_preview_setthemestyle' );
