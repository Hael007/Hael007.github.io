...
if( !class_exists( 'Newsis_Theme_Info' ) ) :
    class Newsis_Theme_Info {
        ...
        function __construct() {
            ...
            if( isset( $_GET['newsis_welcome_notice_dismiss'] ) ) {
        ...
        function theme_info_scripts($hook) {
            if( ! $this->newsis_disable_admin_notices ) :
                ...
                if( ! get_transient( 'newsis_show_review_notice' ) ) :
                    wp_enqueue_style( 'newsis-review-notice', get_template_directory_uri() . '/inc/admin/assets/review-notice.css', array(), esc_attr( $this->version ), 'all' );
                    wp_enqueue_script( 'newsis-review-notice', get_template_directory_uri() . '/inc/admin/assets/review-notice.js', array( 'jquery' ), esc_attr( $this->version ), true );
                    wp_localize_script( 'newsis-review-notice', 'newsisThemeInfoObject', array(
        ...
        ?>
            <div class="newsis-welcome-notice notice notice-info is-dismissible">
                <h2><?php esc_html_e( 'Newsis Welcome Notice', 'newsis' ); ?></h2>
                <div class="notice-content-wrap">
                    <div class="screenshot-wrap">
                        <img src="<?php echo esc_url( get_template_directory_uri() . '/screenshot.png' ); ?>" height="200" height="200"/>
                    </div>
                    <div class="notice-content">
                        <span class="notice-highlight"><?php esc_html_e( 'You have successfully activated Newsis !! ', 'newsis' ); ?></span>
                        <p><?php esc_html_e( 'Get started with multipurpose news theme and give your site a new look. We recommend you to please go through the documentation to get started with theme and setup homepage quicky.', 'newsis' ); ?></p>
                ...
                <div class="notice-dismiss-button">
                    <a class="" href="<?php echo esc_attr( '?newsis_welcome_notice_dismiss=1' ); ?>"><?php esc_html_e( 'Dismiss this notice', 'newsis' ); ?></a>
                </div>
            </div>
            <?php
        }
        ...
        function add_review_admin_notice() {
            ...
            ?>
            <div class="newsis-review-notice notice notice-success is-dismissible">
